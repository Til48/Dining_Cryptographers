...
<template>
    <div class="card button">
        ...
        <Button label="POV A" severity="secondary" raised class="mb-2 mr-2 raised" /> </a>
    ...
    <div class="card button">
      <Button label="Randomize Shared Secrets" @click="randomizeSharedSecrets" /> <!--- Ranomize Button, randomizes SharedSecrets on click -->
    </div>
        ...
        <div class="container card">
            ...
            <div class="card table1">
                ...
                <table>
                    ...
                    <tr>
                      <td>AB</td>
                      <td>{{ sharedSecrets.AB }}</td> <!--- The value of the secret is imported from the "store.js"-file in the src dictionary -->
                    </tr>
                    <tr>
                      <td>AC</td>
    ...
    <div class="card">
      <h3>POV A: </h3>
            <p><b>Step 1: </b></p>
              <p>The first step of the calculation involves Cryptographer A creating shared one-bit secrets (either 0 or 1) with every other cryptographer at the table. They do this in secret so none other than themselves can see that shared secret. They can achieve this through flipping a coin behind a menu card or behind their back.</p>
              <p><b>Step 2: </b></p>
              <p>In the second step A announces a Bit under the following circumstances.</p>
              <p>If A didn’t pay, he calculates the XOR of all shared secrets he knows of.</p>
              <p>If A paid for the meal, he calculates the XOR of all shared secrets he knows of and inverts that value at the end. E.g. if his calculated value is 1, he inverts it to 0 and announces it.</p>
              <p><b>Step 3: </b></p>
